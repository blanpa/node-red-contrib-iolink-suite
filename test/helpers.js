 ...
 *
 * Tests about timers are otherwise a bet on how fast the machine is: a fixed
 * sleep that passes on a quiet laptop fails on a loaded CI runner, and the
 * failure says nothing about the code.
 */
async function waitFor (condition, { timeout = 4000, step = 10 } = {}) {
...
module.exports = {
  FakeNode, makeRED, loadNodes, fixture, DEMO_IODD, fakeMasterNode, withMaster, waitFor
}
